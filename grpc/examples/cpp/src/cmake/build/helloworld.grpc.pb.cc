...
static const char* Greeter_method_names[] = {
  ...
  "/helloworld.Greeter/CommandImageRequest",
};
...
Greeter::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_CommandImageRequest_(Greeter_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status Greeter::Stub::CommandImageRequest(::grpc::ClientContext* context, const ::helloworld::ImageRequest& request, ::helloworld::ImageResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::helloworld::ImageRequest, ::helloworld::ImageResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_CommandImageRequest_, context, request, response);
}

void Greeter::Stub::async::CommandImageRequest(::grpc::ClientContext* context, const ::helloworld::ImageRequest* request, ::helloworld::ImageResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::helloworld::ImageRequest, ::helloworld::ImageResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CommandImageRequest_, context, request, response, std::move(f));
}

void Greeter::Stub::async::CommandImageRequest(::grpc::ClientContext* context, const ::helloworld::ImageRequest* request, ::helloworld::ImageResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_CommandImageRequest_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::helloworld::ImageResponse>* Greeter::Stub::PrepareAsyncCommandImageRequestRaw(::grpc::ClientContext* context, const ::helloworld::ImageRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::helloworld::ImageResponse, ::helloworld::ImageRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_CommandImageRequest_, context, request);
}

::grpc::ClientAsyncResponseReader< ::helloworld::ImageResponse>* Greeter::Stub::AsyncCommandImageRequestRaw(::grpc::ClientContext* context, const ::helloworld::ImageRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncCommandImageRequestRaw(context, request, cq);
  result->StartCall();
  return result;
}
      ...
      new ::grpc::internal::RpcMethodHandler< Greeter::Service, ::helloworld::ImageRequest, ::helloworld::ImageResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](Greeter::Service* service,
             ...
             ::helloworld::ImageResponse* resp) {
               return service->CommandImageRequest(ctx, req, resp);
             }, this)));
}
...
::grpc::Status Greeter::Service::CommandImageRequest(::grpc::ServerContext* context, const ::helloworld::ImageRequest* request, ::helloworld::ImageResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
